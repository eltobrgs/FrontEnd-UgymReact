...
import { FaChartLine, FaDumbbell, FaUserPlus } from 'react-icons/fa';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2">
          {selectedStudent ? (
            <div className="bg-white rounded-lg shadow-md overflow-hidden mb-6">
              <div className="p-4 border-b flex items-center justify-between">
                <h2 className="text-xl font-semibold text-gray-800">Progresso de {selectedStudent.name}</h2>
                  ...
                  <div className="space-y-8">
                    {Object.entries(reports).map(([tipo, reportData]) => (
                      <div key={tipo} className="mb-6">
                        <h3 className="text-lg font-medium mb-4">{tiposRelatorioPT[tipo] || tipo}</h3>
