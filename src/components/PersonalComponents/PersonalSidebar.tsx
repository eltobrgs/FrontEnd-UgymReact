    ...
    <>
      ...
      >
        ...
        <div className="flex justify-between items-center p-4 border-b border-gray-700">
          ...
          >
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-red-500 to-red-600">Ugym Pro</span>
            <motion.svg 
              stroke="currentColor" 
              fill="currentColor" 
              strokeWidth="0" 
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <div className="flex flex-col">
                <motion.span 
                  className="text-sm px-2 py-1 bg-gradient-to-r from-red-600 to-red-500 rounded-full text-white shadow-md inline-block"
                  initial={{ opacity: 0, x: -20 }}
                  animate={{ opacity: 1, x: 0 }}
