...
const AcademiaSidebar: FC<AcademiaSidebarProps> = ({ userName, userImage, isOpen, onToggle }) => {
  const menuItems = [
    ...
    <>
      ...
      >
        ...
        <div className="flex justify-between items-center p-4 border-b border-gray-700">
          ...
          >
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-red-500 to-red-600">Ugym Business</span>
            <motion.svg 
              stroke="currentColor" 
              fill="currentColor" 
              strokeWidth="0" 
        ...
        >
          <div className="flex items-center space-x-4">
            <motion.img 
              src={userImage || 'https://images.unsplash.com/photo-1517836357463-d25dfeac3438?w=500&h=500&fit=crop'} 
              alt={userName}
